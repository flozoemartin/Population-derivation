...
* Program to pull out BMI records for each CPRD patient

* Author: Krishnan Bhaskaran (adapted by Flo Martin)
...
********************************************************************************
	...
	program define pr_getallbmirecords
		...
		* Put underscores before the generated variable names
		...
		* Replicate the CPRD height policy (i.e. take the last one, or the first one for records pre- first height)
		...
		* Note CPRD seem to round down the 1st DP regardless
